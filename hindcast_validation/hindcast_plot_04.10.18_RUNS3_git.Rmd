...
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_04.10.18_run3.csv")%>% group_by(sp) %>% as.data.frame() #%>% dplyr::sample_n(size=445) %>% as.data.frame()
...
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_04.10.18_run3.csv")%>% group_by(sp)%>% dplyr::sample_n(size=445) %>% as.data.frame()
...
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_04.10.18_run3.csv") %>% as.data.frame()#%>% group_by(sp_name)%>% dplyr::sample_n(size=280) %>% as.data.frame()
...
E_ratio=paste0("/Users/heatherwelch/Dropbox/Eco-ROMS/EcoROMSruns/output/hindcast/mean/EcoROMS_ratio_",paste0(ER_weightings,collapse="_"),"_1995-09-11_mean.png")
...
index=grep(algorithm,names(master))
subtitle=paste0(namesrisk[1],": ",ER_weightings[1],", ",namesrisk[2],": ",ER_weightings[2],", ",namesrisk[3],": ",ER_weightings[3],", ",namesrisk[4],": ",ER_weightings[4],", ",namesrisk[5],": ",ER_weightings[5])
ecoroms_r=ggplot(data=master,aes(x=sp_name,y=master[,index]))+geom_boxplot()
ecoroms_r=ecoroms_r+ggtitle(label = paste0("Weighted ", algorithm," predictions at obs & trk data"),subtitle = subtitle)+labs(x="Species catch events")+labs(y="Althorithm prediction")+theme(panel.background = element_blank())+ theme(axis.line = element_line(colour = "black"))+ theme(text = element_text(size=8))
ecoroms_r
...
index=NULL
index=grep(algorithm,names(master))
EcoROMS_original=hist(master[master$sp_name=="sworobs",index],breaks=c(-1,-.75,-.5,-.25,0,.25,.5,.75,1))
EcoROMS_original$density=EcoROMS_original$counts/sum(EcoROMS_original$counts)*100
plot(EcoROMS_original,col=rgb(1,0,0,0.3),xlim=c(-1,1),ylim=c(0,50),main=paste0(algorithm,", weightings: ",paste0(ER_weightings,collapse = "_")),xlab="Product threshold bins",ylab="Percent of catch events",freq=F,cex.lab=.7,cex.axis=.7)

algorithm="EcoROMS_ratio"
index=NULL
index=grep(algorithm,names(master))
EcoROMS_ratio=hist(master[master$sp_name=="sworobs",index],breaks=c(-1,-.75,-.5,-.25,0,.25,.5,.75,1))
EcoROMS_ratio$density=EcoROMS_ratio$counts/sum(EcoROMS_ratio$counts)*100
plot(EcoROMS_ratio,col=rgb(1,0,0,0.3),xlim=c(-1,1),ylim=c(0,50),main=paste0(algorithm,", weightings: ",paste0(ER_weightings,collapse = "_")),xlab="Product threshold bins",ylab="Percent of catch events",freq=F,cex.lab=.7,cex.axis=.7)

algorithm="Marxan_raw"
index=NULL
index=grep(algorithm,names(master))
Marxan_raw=hist(master[master$sp_name=="sworobs",index],breaks=c(-1,-.75,-.5,-.25,0,.25,.5,.75,1))
Marxan_raw$density=Marxan_raw$counts/sum(Marxan_raw$counts)*100
plot(Marxan_raw,col=rgb(1,0,0,0.3),xlim=c(-1,1),ylim=c(0,50),main=paste0(algorithm,", weightings: ",paste0(M_weightings,collapse = "_")),xlab="Product threshold bins",ylab="Percent of catch events",freq=F,cex.lab=.7,cex.axis=.7)
...
index=NULL
index=grep(algorithm,names(master))
EcoROMS_original=hist(master[master$sp=="lbst",index],breaks=c(-1,-.75,-.5,-.25,0,.25,.5,.75,1))
EcoROMS_original$density=EcoROMS_original$counts/sum(EcoROMS_original$counts)*100
plot(EcoROMS_original,col=rgb(1,0,0,0.3),xlim=c(-1,1),ylim=c(0,50),main=paste0(algorithm,", weightings: ",paste0(ER_weightings,collapse = "_")),xlab="Product threshold bins",ylab="Percent of bycatch + tracking data",freq=F,cex.lab=.7,cex.axis=.7)

algorithm="EcoROMS_ratio"
index=NULL
index=grep(algorithm,names(master))
EcoROMS_ratio=hist(master[master$sp=="lbst",index],breaks=c(-1,-.75,-.5,-.25,0,.25,.5,.75,1))
EcoROMS_ratio$density=EcoROMS_ratio$counts/sum(EcoROMS_ratio$counts)*100
plot(EcoROMS_ratio,col=rgb(1,0,0,0.3),xlim=c(-1,1),ylim=c(0,50),main=paste0(algorithm,", weightings: ",paste0(ER_weightings,collapse = "_")),xlab="Product threshold bins",ylab="Percent of bycatch + tracking data",freq=F,cex.lab=.7,cex.axis=.7)

algorithm="Marxan_raw"
index=NULL
index=grep(algorithm,names(master))
Marxan_raw=hist(master[master$sp=="lbst",index],breaks=c(-1,-.75,-.5,-.25,0,.25,.5,.75,1))
Marxan_raw$density=Marxan_raw$counts/sum(Marxan_raw$counts)*100
plot(Marxan_raw,col=rgb(1,0,0,0.3),xlim=c(-1,1),ylim=c(0,50),main=paste0(algorithm,", weightings: ",paste0(M_weightings,collapse = "_")),xlab="Product threshold bins",ylab="Percent of bycatch + tracking data",freq=F,cex.lab=.7,cex.axis=.7)
...
plot(EcoROMS_ratio,col=rgb(1,0,0,0.3),xlim=c(-1,1),ylim=c(0,50),main=paste0("EcoROMS ratio, weightings: ",paste0(ER_weightings,collapse = "_")),xlab="Product threshold bins",ylab="Percent of bycatch events",freq=F,cex.lab=.7,cex.axis=.7)
plot(Marxan_raw,col=rgb(1,0,0,0.3),xlim=c(-1,1),ylim=c(0,50),main=paste0("Marxan raw, weightings: ",paste0(M_weightings,collapse = "_")),xlab="Product threshold bins",ylab="Percent of bycatch events",freq=F,cex.lab=.7,cex.axis=.7)
```
...
```{r, echo=FALSE,message=F, warning=F,out.width='50%'}
clean=master[complete.cases(master),] %>% filter(sp=="swor")
map.US <- map_data(map="state")
...
```{r, echo=FALSE,message=F, warning=F,out.width='50%'}
clean=master[complete.cases(master),] %>% filter(sp=="lbst")
map.US <- map_data(map="state")

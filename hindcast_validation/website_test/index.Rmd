...
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_1997_2005_run1.csv")
...
a=a+coord_cartesian(xlim=c(-133,-115),ylim=c(29,49),expand=FALSE)+ggtitle("Raw data")
a
...
a=a+coord_cartesian(xlim=c(-133,-115),ylim=c(29,49),expand=FALSE)+ggtitle("Random data")
a
...
```{r, echo=FALSE,message=FALSE, warning=FALSE,out.width='50%',fig.show = 'hold',include=FALSE}
algorithm="EcoROMS"
index=NULL
index=grep(algorithm,names(master))
...
plot(EcoROMS,col=rgb(1,0,0,0.3),xlim=c(-1,1),ylim=c(0,50),main=paste0(algorithm,", weightings: ",paste0(ER_weightings,collapse = "_")),xlab="Product threshold bins",ylab="Percent of bycatch events",freq=FALSE,cex.lab=.7,cex.axis=.7)
...
plot(Marxan_raw,col=rgb(1,0,0,0.3),xlim=c(-1,1),ylim=c(0,50),main=paste0(algorithm,", weightings: ",paste0(M_weightings,collapse = "_")),xlab="Product threshold bins",ylab="Percent of bycatch events",freq=FALSE,cex.lab=.7,cex.axis=.7)
...
plot(Marxan_mosaic,col=rgb(1,0,0,0.3),xlim=c(-1,1),ylim=c(0,50),main=paste0(algorithm,", weightings: ",paste0(M_weightings,collapse = "_")),xlab="Product threshold bins",ylab="Percent of bycatch events",freq=FALSE,cex.lab=.7,cex.axis=.7)
...
plot(Marxan_mosaic01,col=rgb(1,0,0,0.3),xlim=c(-1,1),ylim=c(0,50),main=paste0(algorithm,", weightings: ",paste0(M_weightings,collapse = "_")),xlab="Product threshold bins",ylab="Percent of bycatch events",freq=FALSE,cex.lab=.7,cex.axis=.7)

```

```{r, echo=FALSE,message=FALSE, warning=FALSE,out.width='50%',fig.show = 'hold'}
plot(EcoROMS,col=rgb(1,0,0,0.3),xlim=c(-1,1),ylim=c(0,50),main=paste0("EcoROMS, weightings: ",paste0(ER_weightings,collapse = "_")),xlab="Product threshold bins",ylab="Percent of bycatch events",freq=FALSE,cex.lab=.7,cex.axis=.7)

plot(Marxan_raw,col=rgb(1,0,0,0.3),xlim=c(-1,1),ylim=c(0,50),main=paste0("Marxan raw, weightings: ",paste0(M_weightings,collapse = "_")),xlab="Product threshold bins",ylab="Percent of bycatch events",freq=FALSE,cex.lab=.7,cex.axis=.7)

plot(Marxan_mosaic,col=rgb(1,0,0,0.3),xlim=c(-1,1),ylim=c(0,50),main=paste0("Marxan mosaic, weightings: ",paste0(M_weightings,collapse = "_")),xlab="Product threshold bins",ylab="Percent of bycatch events",freq=FALSE,cex.lab=.7,cex.axis=.7)

plot(Marxan_mosaic01,col=rgb(1,0,0,0.3),xlim=c(-1,1),ylim=c(0,50),main=paste0("Marxan mosaic01, weightings: ",paste0(M_weightings,collapse = "_")),xlab="Product threshold bins",ylab="Percent of bycatch events",freq=FALSE,cex.lab=.7,cex.axis=.7)
```
...
a=a+coord_cartesian(xlim=c(-133,-115),ylim=c(29,49),expand=FALSE)
a
...
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_1997_2005_run2.csv")
...
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_1997_2005_run3.csv")

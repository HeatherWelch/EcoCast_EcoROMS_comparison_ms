...
#### -------------------------------------------------- > ## (run 5) extreme lbst, upweighted swor ####
...
write.csv(master,"/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_04.24.18_run5.csv")
...
write.csv(master,"/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_04.24.18_random_run5.csv")

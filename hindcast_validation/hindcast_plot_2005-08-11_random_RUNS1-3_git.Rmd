...
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_2005_08_10_random_run1.csv")
...
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_2005_08_10_random_run1.csv")%>% gather(sp_name,value,-c(X,lon,lat,dt,EcoROMS,Marxan_raw,Marxan_mosaic,Marxan_mosaic01))
...
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_2005_08_10_random_run2.csv")%>% gather(sp_name,value,-c(X,lon,lat,dt,EcoROMS,Marxan_raw,Marxan_mosaic,Marxan_mosaic01))

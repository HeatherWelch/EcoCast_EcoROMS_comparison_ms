...
#### -------------------------------------------------- > ## (run 6) extreme lbst, upweighted swor ####
...
write.csv(master,"/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_04.25.18_run6.csv")
...
write.csv(master,"/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_04.25.18_random_run6.csv")

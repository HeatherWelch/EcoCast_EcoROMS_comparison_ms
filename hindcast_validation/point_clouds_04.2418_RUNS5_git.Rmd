...
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_04.24.18_run5.csv")%>% group_by(sp) %>% as.data.frame() #%>% dplyr::sample_n(size=445) %>% as.data.frame()
...
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_04.24.18_run5.csv")%>% group_by(sp)%>% dplyr::sample_n(size=445) %>% as.data.frame()
...
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_04.24.18_run5.csv") %>% as.data.frame()#%>% group_by(sp_name)%>% dplyr::sample_n(size=280) %>% as.data.frame()
...
ER_weightings<-c(-0.1,-0.1,-0.05,-2.5,1.5)
M_weightings<-c(-0.1,-0.1,-0.05,-0.4,0.2)
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_04.24.18_random_run5.csv")%>% gather(sp_name,value,-c(X,lon,lat,dt,EcoROMS_original,Marxan_raw))

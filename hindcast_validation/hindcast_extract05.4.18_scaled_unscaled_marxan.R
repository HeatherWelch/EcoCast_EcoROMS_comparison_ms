...
## this is an extraction of all runs on scaled and unscaled EcoCast
...
species=regular@coords %>% as.tibble() %>% dplyr::select(lon=x1,lat=x2) %>% add_column(dt=datess[1:1700])
...
################## -------------------- write out
write.csv(master,"/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_05.02.18_random_scaled_unscaled_run4.csv")
...
################## -------------------- write out
write.csv(master,"/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_05.02.18_random_scaled_unscaled_run5.csv")
...
################## -------------------- write out
write.csv(master,"/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_05.02.18_random_scaled_unscaled_run6.csv")

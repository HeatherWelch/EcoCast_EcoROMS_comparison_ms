#### on 1997 10 - 11 hindcast, and 2005 08-11 hindcast, AND trying out a random sample of species habitat suitability layers AND trying new ratio function for ecoroms and inverted swor as a conservation feature for marxan
...
ecoroms=list.files("~/Dropbox/Eco-ROMS/EcoROMSruns/output/mean",pattern=".grd",full.names = T) %>% grep(paste0(ER_weightings,collapse="_"),.,value=T) %>% grep("ratio",.,value=T)
...
write.csv(master,"/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_1997_2005_newfunctions_run1.csv")
...
write.csv(master,"/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_1997_2005_newfunctions_run2.csv")
...
write.csv(master,"/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_1997_2005_newfunctions_run3.csv")
...
write.csv(master,"/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_1997_2005_newfunctions_random_run1.csv")
...
write.csv(master,"/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_1997_2005_newfunctions_random_run2.csv")
...
write.csv(master,"/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_1997_2005_newfunctions_random_run3.csv")

...
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_1997_2005_newfunctions_run1.csv")%>% group_by(sp_name)%>% dplyr::sample_n(size=280) %>% as.data.frame()
...
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_1997_2005_newfunctions_random_run1.csv")
clean=master[complete.cases(master),]
map.US <- map_data(map="state")
...
ER=paste0("/Users/heatherwelch/Dropbox/Eco-ROMS/EcoROMSruns/output/mean/EcoROMS_ratio_",paste0(ER_weightings,collapse="_"),"_2005-08-01_mean.png")
...
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_1997_2005_newfunctions_run2.csv")%>% group_by(sp_name)%>% dplyr::sample_n(size=280) %>% as.data.frame()
...
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_1997_2005_newfunctions_run3.csv")%>% group_by(sp_name)%>% dplyr::sample_n(size=280) %>% as.data.frame()
...
ER_weightings<-c(-0.1,-0.1,-0.05,-0.9,0.9)
M_weightings<-c(-0.1,-0.1,-0.05,-0.2,0.1)
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_1997_2005_newfunctions_random_run1.csv")%>% gather(sp_name,value,-c(X,lon,lat,dt,EcoROMS,Marxan_raw,Marxan_mosaic,Marxan_mosaic01))
...
ER_weightings<-c(-0.1,-0.1,-0.05,-1.5,2)
M_weightings<-c(-0.1,-0.1,-0.05,-0.3,0.6)
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_1997_2005_newfunctions_random_run2.csv")%>% gather(sp_name,value,-c(X,lon,lat,dt,EcoROMS,Marxan_raw,Marxan_mosaic,Marxan_mosaic01))
...
ER_weightings<-c(-0.1,-0.1,-0.05,-1.5,.1)
M_weightings<-c(-0.1,-0.1,-0.05,-0.3,0.1)
master=read.csv("/Volumes/SeaGate/EcoCast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/raw_data/species_predict_1997_2005_newfunctions_random_run3.csv")%>% gather(sp_name,value,-c(X,lon,lat,dt,EcoROMS,Marxan_raw,Marxan_mosaic,Marxan_mosaic01))

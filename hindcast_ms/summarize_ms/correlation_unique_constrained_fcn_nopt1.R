...
correlations_unique_constrained_nopt1=function(datadir,plotdir,cons_obj1,cons_obj2,cons_obj3,type){
...
png(paste0(plotdir,"parellel_coordinate_plot_correlations_unique_constrained_",type,"_nopt1.png"),width=14, height=7, units="in", res=400)
par(ps=10)
par(cex=1)
par(mar=c(4,4,1,1))
...
write.csv(c,paste0(plotdir,"parellel_coordinate_table_correlations_unique_constrained_",type,"_nopt1.csv"))
...
png(paste0(plotdir,"parellel_coordinate_plot_correlations_box_plot_unique_constrained_",type,"_nopt1.png"),width=7, height=3.5, units="in", res=400)
par(ps=10)
par(cex=1)
par(mar=c(4,4,1,1))
print({plot_grid(a)})

...
## same as histograms 1, but warm years (1997, 2005) only
...
png(paste0(plotdir_ms,"histograms4.png"),width=20, height=8, units="in", res=400)
par(ps=10)
par(cex=1)
par(mar=c(4,4,1,1))
...
file=paste0(plotdir_ms,"histograms4.png")
...
a
image_write(a,path = paste0(plotdir_ms,"histograms4.png"))

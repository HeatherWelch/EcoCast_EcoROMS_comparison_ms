...
thresholds_unique_nopt1=function(csvdir,plotdir,lbstRisk){
...
png(paste0(plotdir,"parellel_coordinate_plot_thresholds_",lbstRisk,"_lbst_unique_nopt1.png"),width=14, height=7, units="in", res=400)
par(ps=10)
par(cex=1)
par(mar=c(4,4,1,1))
...
write.csv(c,paste0(plotdir,"parellel_coordinate_table_thresholds_",lbstRisk,"_lbst_unique_nopt1.csv"))
...
png(paste0(plotdir,"parellel_coordinate_boxplot_thresholds_",lbstRisk,"_lbst_unique_nopt1.png"),width=7, height=3.5, units="in", res=400)
par(ps=10)
par(cex=1)
par(mar=c(4,4,1,1))
print({a})

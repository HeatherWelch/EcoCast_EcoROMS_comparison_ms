...
correlations=function(datadir,plotdir){
...
png(paste0(plotdir,"parellel_coordinate_plot_correlations.png"),width=14, height=7, units="in", res=400)
par(ps=10)
par(cex=1)
par(mar=c(4,4,1,1))
...
write.csv(c,paste0(plotdir,"parellel_coordinate_table_correlations.csv"))
...
# correlations(plotdir = plotdir,datadir = datadir)

...
EcoC.1=read.csv("hindcast_ms/extract/extractions/run_E.1.csv") %>% mutate(weighting="+0.7/-0.3")%>% mutate(weighting=as.factor(weighting)) %>% mutate(Year=as.factor(substr(dt,1,4)))%>% mutate("Ocean_state"="Warm")
EcoC.1 <- within(EcoC.1, Ocean_state[Year == '2003'] <- 'Cold')
EcoC.2=read.csv("hindcast_ms/extract/extractions/run_D.4.csv") %>% mutate(weighting="+0.3/-0.7")%>% mutate(weighting=as.factor(weighting)) %>% mutate(Year=as.factor(substr(dt,1,4)))%>% mutate("Ocean_state"="Warm")
...
A2=ggplot(dataframelist,aes(x=swor,y=Marxan_raw_unscaled,group=weighting,color=weighting,shape=Ocean_state))+geom_point(aes(alpha=Ocean_state,color=weighting),size=1)+stat_smooth(se=F)+
  scale_alpha_manual("Ocean State",values = c("Warm"=.3,"Cold"=1))+
...
B2=ggplot(dataframelistB,aes(x=lbst,y=Marxan_raw_unscaled,group=weighting,color=weighting,shape=Ocean_state))+geom_point(aes(alpha=Ocean_state),size=1)+stat_smooth(se=F)+
  scale_alpha_manual("Ocean State",values = c("Warm"=.3,"Cold"=1))+
  scale_color_manual("Weighting",values=c("-0.1"="darkgoldenrod","-0.3"="cornflowerblue","-0.5"="coral1","-0.7"="aquamarine4","-0.9"="dimgray"))+
  scale_shape_manual("Ocean State",values=c("Warm"=3,"Cold"=15))+
  theme(text = element_text(size=5),axis.text = element_text(size=5),plot.title = element_text(hjust=0,size=5),legend.position=c(.1,.3),legend.justification = c(.9,.9),legend.key.size = unit(.5,'lines'))+
...
## C
C1=ggplot(EcoC,aes(x=swor,y=EcoROMS_original_unscaled,group=weighting,color=weighting,shape=Ocean_state))+geom_point(aes(alpha=Ocean_state),size=1)+stat_smooth(se=F)+
  scale_alpha_manual("Ocean State",values = c("Warm"=.3,"Cold"=1))+
  scale_color_manual("Weighting",values=c("+/-0.1"="darkgoldenrod","+0.7/-0.3"="darkgoldenrod","+/-0.5"="coral1","+0.3/-0.7"="dimgray","+/-0.9"="dimgray"))+
  scale_shape_manual("Ocean State",values=c("Warm"=3,"Cold"=15))+
  theme(text = element_text(size=5),axis.text = element_text(size=5),plot.title = element_text(hjust=0,size=5),legend.position=c(.1,.95),legend.justification = c(.9,.9),legend.key.size = unit(.5,'lines'))+
  theme(legend.background = element_blank(),legend.box.background = element_rect(colour = NA),legend.margin=unit(0.3, "lines"))+
...
C2=ggplot(dataframelistC,aes(x=swor,y=Marxan_raw_unscaled,group=weighting,color=weighting,shape=Ocean_state))+geom_point(aes(alpha=Ocean_state),size=1)+stat_smooth(se=F)+
  scale_alpha_manual("Ocean State",values = c("Warm"=.3,"Cold"=1))+
  scale_color_manual("Weighting",values=c("+/-0.1"="darkgoldenrod","+/-0.3"="cornflowerblue","+/-0.5"="coral1","+/-0.7"="aquamarine4","+/-0.9"="dimgray"))+
  scale_shape_manual("Ocean State",values=c("Warm"=3,"Cold"=15))+
  theme(text = element_text(size=5),axis.text = element_text(size=5),plot.title = element_text(hjust=0,size=5),legend.position=c(.1,.95),legend.justification = c(.9,.9),legend.key.size = unit(.5,'lines'))+
...
C3=ggplot(EcoC,aes(x=lbst,y=EcoROMS_original_unscaled,group=weighting,color=weighting,shape=Ocean_state))+geom_point(aes(alpha=Ocean_state),size=1)+stat_smooth(se=F)+
  scale_alpha_manual("Ocean State",values = c("Warm"=.3,"Cold"=1))+
  scale_color_manual("Weighting",values=c("+/-0.1"="darkgoldenrod","+0.7/-0.3"="darkgoldenrod","+/-0.5"="coral1","+0.3/-0.7"="dimgray","+/-0.9"="dimgray"))+
  scale_shape_manual("Ocean State",values=c("Warm"=3,"Cold"=15))+
  theme(text = element_text(size=5),axis.text = element_text(size=5),plot.title = element_text(hjust=0,size=5),legend.position=c(.1,.3),legend.justification = c(.9,.9),legend.key.size = unit(.5,'lines'))+
...
C4=ggplot(dataframelistC,aes(x=lbst,y=Marxan_raw_unscaled,group=weighting,color=weighting,shape=Ocean_state))+geom_point(aes(alpha=Ocean_state),size=1)+stat_smooth(se=F)+
  scale_alpha_manual("Ocean State",values = c("Warm"=.3,"Cold"=1))+
  scale_color_manual("Weighting",values=c("+/-0.1"="darkgoldenrod","+/-0.3"="cornflowerblue","+/-0.5"="coral1","+/-0.7"="aquamarine4","+/-0.9"="dimgray"))+
  scale_shape_manual("Ocean State",values=c("Warm"=3,"Cold"=15))+
...
png(paste0(plotdir_ms,"figure2_changing_weightings_temp.png"),width=20, height=8, units="in", res=400)
par(ps=10)
par(cex=1)
par(mar=c(4,4,1,1))
...
file=paste0(plotdir_ms,"figure2_changing_weightings_temp.png")
...
a
image_write(a,path = paste0(plotdir_ms,"figure2_changing_weightings_temp.png"))

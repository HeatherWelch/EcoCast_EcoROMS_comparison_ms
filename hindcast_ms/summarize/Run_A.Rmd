...
thresholds=read.csv("/Users/heatherwelch/Dropbox/EcoEast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/hindcast_ms/summarize/csvs/A_thresholds_weighting_comparison.csv")
...
c=paste0("/Users/heatherwelch/Dropbox/Eco-ROMS/EcoROMSruns/output/hindcast_ms/marxan_run_A/marxan_",paste0(weightings,collapse="_"),"_1995-09-11_raw.png")
d=paste0("/Users/heatherwelch/Dropbox/Eco-ROMS/EcoROMSruns/output/hindcast_ms/marxan_run_A/marxan_",paste0(weightings,collapse="_"),"_1995-09-11_raw_unscaled.png")
...
c=paste0("/Users/heatherwelch/Dropbox/Eco-ROMS/EcoROMSruns/output/hindcast_ms/marxan_run_A/marxan_nocost_",paste0(weightings,collapse="_"),"_1995-09-11_raw.grd") %>% raster() 
...
d=paste0("/Users/heatherwelch/Dropbox/Eco-ROMS/EcoROMSruns/output/hindcast_ms/marxan_run_A/marxan_",paste0(weightings,collapse="_"),"_1995-09-11_raw_unscaled.grd") %>% raster() 
...
i=2
weightings <-c(0,0,0,0,0.3) #run A.1  
a=paste0("/Users/heatherwelch/Dropbox/Eco-ROMS/EcoROMSruns/output/hindcast_ms/mean/EcoROMS_original_",paste0(weightings,collapse="_"),"_1995-09-11_mean.grd") %>% raster() %>% crop(.,extent(studyarea))
a[a>thresh10$EcoROMS_original[i]]<-1
a[a<thresh10$EcoROMS_original[i]]<--1
a[a==thresh10$EcoROMS_original[i]]<-NA
...
i=3
weightings <-c(0,0,0,0,0.5) #run A.1  
a=paste0("/Users/heatherwelch/Dropbox/Eco-ROMS/EcoROMSruns/output/hindcast_ms/mean/EcoROMS_original_",paste0(weightings,collapse="_"),"_1995-09-11_mean.grd") %>% raster() %>% crop(.,extent(studyarea))
a[a>thresh10$EcoROMS_original[i]]<-1
a[a<thresh10$EcoROMS_original[i]]<--1
a[a==thresh10$EcoROMS_original[i]]<-NA
...
i=4
weightings <-c(0,0,0,0,0.7) #run A.1  
a=paste0("/Users/heatherwelch/Dropbox/Eco-ROMS/EcoROMSruns/output/hindcast_ms/mean/EcoROMS_original_",paste0(weightings,collapse="_"),"_1995-09-11_mean.grd") %>% raster() %>% crop(.,extent(studyarea))
a[a>thresh10$EcoROMS_original[i]]<-1
a[a<thresh10$EcoROMS_original[i]]<--1
a[a==thresh10$EcoROMS_original[i]]<-NA
...
i=5
weightings <-c(0,0,0,0,0.9) #run A.1  
a=paste0("/Users/heatherwelch/Dropbox/Eco-ROMS/EcoROMSruns/output/hindcast_ms/mean/EcoROMS_original_",paste0(weightings,collapse="_"),"_1995-09-11_mean.grd") %>% raster() %>% crop(.,extent(studyarea))
a[a>thresh10$EcoROMS_original[i]]<-1
a[a<thresh10$EcoROMS_original[i]]<--1
a[a==thresh10$EcoROMS_original[i]]<-NA

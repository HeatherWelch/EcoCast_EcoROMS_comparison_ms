...
thresholds=read.csv("/Users/heatherwelch/Dropbox/EcoEast_EcoROMS_comparison_ms/EcoCast_EcoROMS_comparison_ms/hindcast_ms/summarize/csvs/B_thresholds_weighting_comparison.csv")
...
### visualization of threshold effect at 0% allowable leatherback bycatch risk. Red = waters below threshold (do not fish), blue = waters above threshold (fist), white = waters at threshold (NA, values not considered fishable or unfishable)

```{r , echo=FALSE, out.width='25%'}
cuts=c(-1,0,1)
pal=colorRampPalette(c("red","blue"))
thresh10=thresholds %>% filter(catch==0.0)
...
c=paste0("/Users/heatherwelch/Dropbox/Eco-ROMS/EcoROMSruns/output/hindcast_ms/marxan/marxan_",paste0(weightings,collapse="_"),"_1995-09-11_raw.grd") %>% raster() 
...
i=2
weightings <-c(0,0,0,-0.3,0) #run A.1  
a=paste0("/Users/heatherwelch/Dropbox/Eco-ROMS/EcoROMSruns/output/hindcast_ms/mean/EcoROMS_original_",paste0(weightings,collapse="_"),"_1995-09-11_mean.grd") %>% raster() %>% crop(.,extent(studyarea))
a[a>thresh10$EcoROMS_original[i]]<-1
a[a<thresh10$EcoROMS_original[i]]<--1
a[a==thresh10$EcoROMS_original[i]]<-NA
...
i=3
weightings <-c(0,0,0,-0.5,0) #run A.1  
a=paste0("/Users/heatherwelch/Dropbox/Eco-ROMS/EcoROMSruns/output/hindcast_ms/mean/EcoROMS_original_",paste0(weightings,collapse="_"),"_1995-09-11_mean.grd") %>% raster() %>% crop(.,extent(studyarea))
a[a>thresh10$EcoROMS_original[i]]<-1
a[a<thresh10$EcoROMS_original[i]]<--1
a[a==thresh10$EcoROMS_original[i]]<-NA
...
i=4
weightings <-c(0,0,0,-0.7,0) #run A.1  
a=paste0("/Users/heatherwelch/Dropbox/Eco-ROMS/EcoROMSruns/output/hindcast_ms/mean/EcoROMS_original_",paste0(weightings,collapse="_"),"_1995-09-11_mean.grd") %>% raster() %>% crop(.,extent(studyarea))
a[a>thresh10$EcoROMS_original[i]]<-1
a[a<thresh10$EcoROMS_original[i]]<--1
a[a==thresh10$EcoROMS_original[i]]<-NA
...
i=5
weightings <-c(0,0,0,-0.9,0) #run A.1  
a=paste0("/Users/heatherwelch/Dropbox/Eco-ROMS/EcoROMSruns/output/hindcast_ms/mean/EcoROMS_original_",paste0(weightings,collapse="_"),"_1995-09-11_mean.grd") %>% raster() %>% crop(.,extent(studyarea))
a[a>thresh10$EcoROMS_original[i]]<-1
a[a<thresh10$EcoROMS_original[i]]<--1
a[a==thresh10$EcoROMS_original[i]]<-NA

...
plotdir_ms="./hindcast_ms/figures.01.10.19/plots/"#;dir.create(plotdir_ms)
  ...
  png(paste0(plotdir_ms,"figure4_changing_species_scaled.png"),width=20, height=8, units="in", res=400)
  par(ps=10)
  par(cex=1)
  par(mar=c(4,4,1,1))
  ...
  file=paste0(plotdir_ms,"figure4_changing_species_scaled.png")
  ...
  a
  image_write(a,path = paste0(plotdir_ms,"figure4_changing_species_scaled.png"))
